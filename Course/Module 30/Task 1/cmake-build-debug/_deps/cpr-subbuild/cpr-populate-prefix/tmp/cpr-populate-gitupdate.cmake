...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "A:/Programs/Git/cmd/git.exe" rev-parse "${ref}^0"
...
execute_process(
  COMMAND "A:/Programs/Git/cmd/git.exe" show-ref "c8d33915dbd88ad6c92b258869b03aba06587ff9"
  WORKING_DIRECTORY "A:/Programming/Projects--c---/Course/Module 30/Task 1/cmake-build-debug/_deps/cpr-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "A:/Programs/Git/cmd/git.exe" fetch --tags --force "origin"
    WORKING_DIRECTORY "A:/Programming/Projects--c---/Course/Module 30/Task 1/cmake-build-debug/_deps/cpr-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "A:/Programs/Git/cmd/git.exe" symbolic-ref -q HEAD
    WORKING_DIRECTORY "A:/Programming/Projects--c---/Course/Module 30/Task 1/cmake-build-debug/_deps/cpr-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "A:/Programs/Git/cmd/git.exe" for-each-ref "--format='%(upstream:short)'" "${current_branch}"
      WORKING_DIRECTORY "A:/Programming/Projects--c---/Course/Module 30/Task 1/cmake-build-debug/_deps/cpr-src"
...
execute_process(
  COMMAND "A:/Programs/Git/cmd/git.exe" status --porcelain
  WORKING_DIRECTORY "A:/Programming/Projects--c---/Course/Module 30/Task 1/cmake-build-debug/_deps/cpr-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "A:/Programs/Git/cmd/git.exe" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "A:/Programming/Projects--c---/Course/Module 30/Task 1/cmake-build-debug/_deps/cpr-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "A:/Programs/Git/cmd/git.exe" checkout "${checkout_name}"
    WORKING_DIRECTORY "A:/Programming/Projects--c---/Course/Module 30/Task 1/cmake-build-debug/_deps/cpr-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "A:/Programs/Git/cmd/git.exe" rebase "${checkout_name}"
    WORKING_DIRECTORY "A:/Programming/Projects--c---/Course/Module 30/Task 1/cmake-build-debug/_deps/cpr-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "A:/Programs/Git/cmd/git.exe" rebase --abort
      WORKING_DIRECTORY "A:/Programming/Projects--c---/Course/Module 30/Task 1/cmake-build-debug/_deps/cpr-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "A:/Programs/Git/cmd/git.exe" stash pop --index --quiet
          WORKING_DIRECTORY "A:/Programming/Projects--c---/Course/Module 30/Task 1/cmake-build-debug/_deps/cpr-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'A:/Programming/Projects--c---/Course/Module 30/Task 1/cmake-build-debug/_deps/cpr-src'."
    ...
    execute_process(
      COMMAND "A:/Programs/Git/cmd/git.exe" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "A:/Programs/Git/cmd/git.exe" reset --hard --quiet
      WORKING_DIRECTORY "A:/Programming/Projects--c---/Course/Module 30/Task 1/cmake-build-debug/_deps/cpr-src"
    )
    execute_process(
      COMMAND "A:/Programs/Git/cmd/git.exe" stash pop --quiet
      WORKING_DIRECTORY "A:/Programming/Projects--c---/Course/Module 30/Task 1/cmake-build-debug/_deps/cpr-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "A:/Programs/Git/cmd/git.exe" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "A:/Programming/Projects--c---/Course/Module 30/Task 1/cmake-build-debug/_deps/cpr-src"
      )
      execute_process(
        COMMAND "A:/Programs/Git/cmd/git.exe" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'A:/Programming/Projects--c---/Course/Module 30/Task 1/cmake-build-debug/_deps/cpr-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
